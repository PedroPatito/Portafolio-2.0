...
import moviex from "../public/assets/projects/chatapp.png"
    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p className=" my-2">
          This is an application that consists of a group chat and a forum where users can make posts with a title, an image, and a paragraph.
          </p>
          {/* <Link href="https://proyecto-baker-e-comerce.web.app/">
          <button  className="px-8 py-2 mt4 mr-8">Demo</button>
          </Link> */}
          <Link href="https://github.com/PedroPatito/Chat-app-RN">
